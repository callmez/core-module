...
@section('title', __('labels.admin.access.users.management') . ' | ' . __('labels.admin.access.users.deactivated'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.admin.access.users.deactivated')</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        @if($users->count())
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="9"><p class="text-center">@lang('strings.admin.access.users.no_deactivated')</p></td></tr>
                        @endif
                        </tbody>
                    </table>
                </div>
